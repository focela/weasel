            ...
            sx={{
              ...
              ...(drawerOpen && {
                ...
                '&.Mui-selected': {
                  ...
                  '&:hover': { color: iconSelectedColor, bgcolor: mode === 'dark' ? 'divider' : 'transparent' }
                }
              }),
              ...(!drawerOpen && {
              ...
              <ListItemIcon
                ...
                sx={{
                  ...
                  ...(!drawerOpen && {
                    ...
                    '&:hover': { bgcolor: mode === 'dark' ? 'secondary.light' : 'secondary.lighter' }
                  }),
                  ...(!drawerOpen &&
                    selected === menu.id && {
                      bgcolor: mode === 'dark' ? 'primary.900' : 'primary.lighter',
                      '&:hover': { bgcolor: mode === 'dark' ? 'primary.darker' : 'primary.lighter' }
                    })
                }}
              >
                {menuIcon}
