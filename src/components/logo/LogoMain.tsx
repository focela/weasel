  ...
  return (
    <>
      <svg width="118" height="35" viewBox="0 0 818 256" xmlns="http://www.w3.org/2000/svg">
        ...
        <linearGradient id="b" x1="69.644116%" x2="54.042898%" y1="0%" y2="108.456714%">
          <stop offset="0" stopColor="#29cdff" />
          <stop offset=".378600687" stopColor="#148eff" />
          <stop offset="1" stopColor="#0a60ff" />
        </linearGradient>
        <linearGradient id="c" x1="69.690817%" x2="16.722898%" y1="-12.974359%" y2="117.391248%">
          <stop offset="0" stopColor="#fa816e" />
          <stop offset=".41472606" stopColor="#f74a5c" />
          <stop offset="1" stopColor="#f51d2c" />
        </linearGradient>
        <linearGradient id="d" x1="68.127987%" x2="30.440091%" y1="-35.690574%" y2="114.942679%">
        ...
        <g fill="none">
          ...
          <path
            ...
            fill="url(#c)"
          />
          <ellipse cx="128.326913" cy="128.241672" fill="url(#d)" rx="30.32671" ry="30.301772" />
        </g>
        <text
          x="310"
          y="190"
